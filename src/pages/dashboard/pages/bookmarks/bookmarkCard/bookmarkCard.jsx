          ...
          <div className={bookmarkCardStyles.bodyHeader}>
            <div className={bookmarkCardStyles.bodyHeaderLeft}>
              <Link
                ...
                // this pass a state to the next page that will be used to trigger a scroll to the actual comment
                state={{
                  postId: bookmark.postType == 'Comment' ? bookmark.post._id : bookmark.postType == 'Answer' ? bookmark.post._id : ' ',
                }}
