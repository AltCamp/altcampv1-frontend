...
import { useGetStudentByIdQuery } from "../../../../../app/slices/apiSlices/studentSlices/allStudentSlices";
...
export default function UserProfile() {
  ...
  return (
    <main className={userProfileStyle.profileContainer}>
        <div
          className={userProfileStyle.back}
          onClick={() => navigate(-1)}
        >
          <ArrowCircleLeft
            size='23'
            className={userProfileStyle.backIcon}
          />
          <div className={userProfileStyle.backText}>
            Back to community
          </div>
          </div>
      {isLoading && (
